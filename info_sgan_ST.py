...
for epoch in range(train_epoch):
    ...
    for D_i in xrange(D_steps):
        ...
        loss_d_, _ = sess.run([D_loss, D_optim], {z_in: zs, x: x_, latent_cat_in:lcat, latent_cont_in:lcont, isTrain: True})
        D_losses.append(loss_d_)
        loss_q_, _ = sess.run([Q_loss, Q_optim], {z_in: zs, x:x_, latent_cat_in:lcat, latent_cont_in:lcont, isTrain: True})
